...
$JUICER -d $CONTACT_MATRIX_DIR -s MboI -g hg19 -t 30 -z $REFERENCE_GENOME -p /path/to/restriction_sites.txt -y /path/to/digest_file.txt
...
echo "Hi-C analysis pipeline complete!"
